...
class ImageCacheController
{
     ...
     * @var string
     */
    const TELESCOPE_LOGO = 'https://updates.telescope-erp.com/telescope.png';
    ...
    {
        try {
            $content = Cache::remember('telescope-logo', 10080, function () {
                return base64_encode($this->getImageFromUrl(self::TELESCOPE_LOGO));
            });
        } catch (Exception $e) {
            $content = '';
        }
